...
class ADBDevice(DeviceProtocol):
    ...
    def get_clipboard(self) -> str:
        ...
        with trace_span(
            ...
            from AutoGLM_GUI.adb.input import get_clipboard_text
    ...
    def set_clipboard(self, text: str) -> None:
        ...
        with trace_span(
            ...
            attrs={"device_id": self._device_id, "device_impl": "adb", "text_length": len(text)},
        ):
            from AutoGLM_GUI.adb.input import set_clipboard_text
    ...
    def paste(self, delay: float | None = None) -> None:
        ...
        with trace_span(
            ...
            adb.paste(self._device_id, delay)
    ...
    def select_all(self, delay: float | None = None) -> None:
        ...
        with trace_span(
            ...
            adb.select_all(self._device_id, delay)
