...
@router.get("/api/devices/{serial}/health")
async def get_device_health(serial: str):
    """Get device health info (battery, storage, memory)."""
    from AutoGLM_GUI.health_monitor import get_device_health
