...
class BrowserSession(BaseModel):
	...
	_connection_lock: asyncio.Lock | None = PrivateAttr(default=None)
	...
	# Watchdogs - typed as TYPE_CHECKING imports to avoid circular imports at runtime
	if TYPE_CHECKING:
	...
	_crash_watchdog: 'CrashWatchdog | None' = PrivateAttr(default=None)
	_downloads_watchdog: 'DownloadsWatchdog | None' = PrivateAttr(default=None)
	_aboutblank_watchdog: 'AboutBlankWatchdog | None' = PrivateAttr(default=None)
	_security_watchdog: 'SecurityWatchdog | None' = PrivateAttr(default=None)
	_storage_state_watchdog: 'StorageStateWatchdog | None' = PrivateAttr(default=None)
	_local_browser_watchdog: 'LocalBrowserWatchdog | None' = PrivateAttr(default=None)
	_default_action_watchdog: 'DefaultActionWatchdog | None' = PrivateAttr(default=None)
	_dom_watchdog: 'DomWatchdog | None' = PrivateAttr(default=None)
	_screenshot_watchdog: 'ScreenshotWatchdog | None' = PrivateAttr(default=None)
	_permissions_watchdog: 'PermissionsWatchdog | None' = PrivateAttr(default=None)
	_recording_watchdog: 'RecordingWatchdog | None' = PrivateAttr(default=None)
	_captcha_watchdog: 'CaptchaWatchdog | None' = PrivateAttr(default=None)
	...
	def model_post_init(self, __context) -> None:
		...
		cloud_api_url = getattr(self.browser_profile, 'cloud_api_url', None)
		cloud_api_key = getattr(self.browser_profile, 'cloud_api_key', None)
		self._cloud_browser_client = CloudBrowserClient(api_base_url=cloud_api_url, api_key=cloud_api_key)
