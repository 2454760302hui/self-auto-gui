...
class CloudBrowserClient:
	...
	def __init__(self, api_base_url: str | None = None, api_key: str | None = None):
		self.api_base_url = api_base_url or CONFIG.BROWSER_USE_CLOUD_API_URL
	...
	async def create_browser(
		...
		# Try to get API key from constructor or environment variable first, then auth config
		api_token = self.api_key or os.getenv('BROWSER_USE_API_KEY')
