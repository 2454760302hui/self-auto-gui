  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold"><span className="xnext-gradient-text">{t.scheduledTasks.title}</span></h1>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {tasks.map(task => (
            <Card key={task.id} className="xnext-card hover:shadow-md transition-shadow">
