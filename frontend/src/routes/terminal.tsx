...
function TerminalRouteComponent() {
  ...
  const statusTone = useMemo(() => {
    ...
    if (status === 'closed') return 'text-zinc-600 bg-zinc-100';
  ...
  return (
    <div className="h-full flex bg-zinc-100 dark:bg-[#0a0e1a]">
      <div className="w-80 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0a0e1a] p-4 flex flex-col gap-4">
        <div>
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/60 p-4 space-y-3">
          ...
          <div className="space-y-1 text-sm text-zinc-600 dark:text-zinc-300">
            ...
            <div>
              <span className="text-zinc-400">{t.terminal.cwdLabel}: </span>
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0a0e1a] p-4 space-y-3">
          <div className="flex items-center justify-between">
            <div>
            ...
            {devices.length === 0 ? (
              ...
              devices.map(device => (
                <button
                  ...
                  className="w-full rounded-xl border border-zinc-200 dark:border-zinc-800 p-3 text-left transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-900"
                >
                  <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="relative mx-4 mt-4 flex-1 overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-[#0a0e1a] shadow-[0_24px_80px_rgba(15,23,42,0.28)]">
          {!session && !isLoading && (
            <div className="absolute inset-x-0 top-20 z-10 mx-auto w-fit rounded-full bg-white/90 px-4 py-2 text-sm text-zinc-600 shadow-sm backdrop-blur dark:bg-zinc-900/80 dark:text-zinc-300">
          ...
          />
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm">
              <div className="flex items-center gap-3 rounded-full bg-zinc-900/90 px-5 py-3 text-sm text-zinc-100 shadow-lg">
