  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold"><span className="xnext-gradient-text">{t.workflows.title}</span></h1>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {workflows.map(workflow => (
            <Card
              key={workflow.uuid}
              className="xnext-card hover:shadow-md transition-shadow"
            >
              <CardHeader>
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        ...
        >
          <DialogHeader className="flex-shrink-0 px-6 pt-6 pb-3 pr-12 border-b border-zinc-200 dark:border-zinc-800">
            <DialogTitle>
          ...
          <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4">
            <div className="space-y-4 pr-1">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-lg border bg-zinc-50/40 dark:bg-zinc-900/30">
                  <div className="space-y-3 p-3">
                    {formData.steps.map((step, index) => (
                      <div
                        key={step.id}
                        className="rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden bg-white dark:bg-zinc-900 shadow-sm"
                      >
                        <div className="flex items-center justify-between px-3 py-2 bg-zinc-100/90 dark:bg-zinc-800/70 border-b border-zinc-200 dark:border-zinc-700">
                          <div className="flex items-center gap-2">
                            <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-500 text-white text-xs font-semibold">
                              {index + 1}
                            </span>
                          ...
                          <div className="flex gap-1">
                            ...
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-7 w-7 rounded-full text-indigo-500 hover:text-indigo-600"
                        ...
                        <div className="p-3 space-y-3">
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              className="h-10 bg-white dark:bg-[#0a0e1a]"
                            />
                          </div>
                          <div className="space-y-1">
                            <Label className="text-xs text-zinc-600 dark:text-zinc-300">
                            ...
                            <Textarea
                              ...
                              rows={7}
                              className="resize-y min-h-[180px] !rounded-lg bg-white dark:bg-[#0a0e1a]"
                            />
                          </div>
                        </div>
                      </div>
          ...
          <DialogFooter className="flex-shrink-0 border-t border-zinc-200 dark:border-zinc-800 px-6 py-4">
