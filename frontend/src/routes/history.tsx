  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold"><span className="xnext-gradient-text">{t.historyPage.title}</span></h1>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {records.map(record => (
            <Card
              key={record.id}
              className="xnext-card hover:shadow-md transition-shadow cursor-pointer"
          ...
          {selectedRecord && (
            <div className="overflow-y-auto max-h-[calc(80vh-120px)] pr-4">
              <div className="space-y-4">
                ...
                {/* Metadata */}
                <div className="flex flex-wrap gap-3 text-xs text-zinc-500 dark:text-zinc-400 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                  <span>
                    {t.historyPage.steps.replace(
                      '{count}',
