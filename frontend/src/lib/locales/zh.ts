export const zh = {
  ...
  record: {
    title: '录制 & 回放',
    description: '录制操作步骤，生成可复用的自动化脚本',
    startRecording: '开始录制',
    stopRecording: '停止录制',
    recording: '录制中...',
    generateCode: '生成代码',
    ...
    run: '运行',
    noActions: '暂无录制操作',
    noActionsHint: '点击"开始录制"后在屏幕上操作',
    noCode: '暂无生成代码',
    noCodeHint: '录制操作后点击"生成代码"',
    noOutput: '暂无运行输出',
    noOutputHint: '生成代码后点击"运行"查看输出',
    executeSuccess: '执行成功',
    executeFailed: '执行失败',
    quickActions: '快捷操作',
    tap: '点击',
  ...
  automation: {
    title: '自动化操作',
    description: '支持的自动化操作一览',
    touchOperations: '触控操作',
    navigationOperations: '导航操作',
    inputOperations: '输入操作',
    appOperations: '应用操作',
