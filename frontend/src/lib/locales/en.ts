export const en = {
  ...
  record: {
    ...
    description: 'Record operation steps and generate reusable automation scripts',
    ...
    noActionsHint: 'Click "Start Recording" and operate on the screen',
    noCode: 'No generated code',
    noCodeHint: 'Record actions and click "Generate Code"',
    noOutput: 'No run output',
    noOutputHint: 'Generate code and click "Run" to see output',
  ...
  automation: {
    title: 'Automation',
    description: 'Supported automation operations',
    touchOperations: 'Touch Operations',
    navigationOperations: 'Navigation Operations',
    inputOperations: 'Input Operations',
    ...
    swipe: 'Swipe',
    scrollUp: 'Swipe Up',
    scrollDown: 'Swipe Down',
    scrollLeft: 'Swipe Left',
    scrollRight: 'Swipe Right',
    back: 'Back',
    home: 'Home',
