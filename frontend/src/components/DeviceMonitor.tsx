  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 z-10">
        <Badge
          variant="secondary"
          className="bg-white/90 text-zinc-700 border border-zinc-200 dark:bg-zinc-900/90 dark:text-zinc-300 dark:border-zinc-700"
        >
      ...
      {/* Feedback message */}
      {feedbackMessage && (
        <div className="absolute bottom-4 right-4 z-20 flex items-center gap-2 px-3 py-2 bg-[#00e5ff] text-white text-sm rounded-xl shadow-lg">
