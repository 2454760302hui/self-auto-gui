              ...
              <div className="space-y-2">
                {groups.map(group => (
                    ...
                    className={`
                      ...
                      ${
                        draggedGroupId === group.id
                          ? 'border-[#00e5ff] bg-blue-50 dark:bg-blue-950/20'
                  ...
                  >
                    {/* Drag handle */}
                    {!group.is_default && (
                      <GripVertical className="w-4 h-4 text-zinc-400 flex-shrink-0 cursor-grab" />
                    )}
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-7 w-7 text-zinc-400 hover:text-[#00e5ff]"
                        onClick={() => {
