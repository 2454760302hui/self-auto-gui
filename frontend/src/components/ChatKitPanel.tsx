            ...
            >
              <PopoverTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 rounded-full text-zinc-400 hover:text-zinc-600 dark:text-zinc-500 dark:hover:text-zinc-300"
                            ...
                            >
                              ...
                              {step.isExpanded && (
                                <div className="px-3 pb-3 space-y-2">
                                  {step.type === 'tool_call' &&
                                    step.toolArgs && (
                                      <div className="bg-white dark:bg-zinc-900 rounded-lg p-3 text-sm">
