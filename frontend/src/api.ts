...
export interface Device {
  ...
  platform: string; // "android" | "harmonyos"
...
export async function sendKeyEvent(
  keycode: number,
  deviceId?: string | null
): Promise<KeyEventResponse> {
  const res = await axios.post<KeyEventResponse>('/api/control/keyevent', {
    keycode,
    device_id: deviceId ?? null,
  });
  return res.data;
...
export async function sendTextInput(
  ...
  const res = await axios.post<TextInputResponse>('/api/control/text', {
    text,
    device_id: deviceId ?? null,
  });
  return res.data;
...
export async function sendBack(
  ...
  const res = await axios.post<ControlResponse>('/api/control/back', {
    device_id: deviceId ?? null,
    delay,
  });
  return res.data;
...
export async function sendHome(
  ...
  const res = await axios.post<ControlResponse>('/api/control/home', {
    device_id: deviceId ?? null,
    delay,
  });
  return res.data;
...
export async function sendLaunchApp(
  app: string,
  deviceId?: string | null,
  delay: number = 0
): Promise<ControlResponse> {
  const res = await axios.post<ControlResponse>('/api/control/launch', {
    app,
    device_id: deviceId ?? null,
    delay,
  });
...
export async function sendDoubleTap(
  x: number,
  y: number,
  deviceId?: string | null,
  delay: number = 0
): Promise<ControlResponse> {
  const res = await axios.post<ControlResponse>('/api/control/double-tap', {
    x: Math.round(x),
    y: Math.round(y),
    device_id: deviceId ?? null,
    delay,
...
export async function sendLongPress(
  x: number,
  y: number,
  ...
  const res = await axios.post<ControlResponse>('/api/control/long-press', {
    x: Math.round(x),
    y: Math.round(y),
...
export async function sendClearText(
  ...
  const res = await axios.post<ControlResponse>('/api/control/clear', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function sendScroll(
  ...
  const res = await axios.post<ControlResponse>('/api/control/scroll', {
    direction,
    distance,
    device_id: deviceId ?? null,
    delay,
...
export interface ScreenshotControlResponse {
  success: boolean;
  image: string;
  width: number;
  height: number;
...
export async function getControlScreenshot(
  deviceId?: string | null
): Promise<ScreenshotControlResponse> {
  const res = await axios.post<ScreenshotControlResponse>('/api/control/screenshot', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function getUiDump(
  deviceId?: string | null
): Promise<UiDumpResponse> {
  const res = await axios.post<UiDumpResponse>('/api/control/ui-dump', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function getCurrentApp(
  deviceId?: string | null
): Promise<CurrentAppResponse> {
  const res = await axios.post<CurrentAppResponse>('/api/control/current-app', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function setClipboard(
  ...
  const res = await axios.post<ControlResponse>('/api/control/clipboard/set', {
    text,
    device_id: deviceId ?? null,
  });
  return res.data;
...
export async function getClipboard(
  deviceId?: string | null
): Promise<ClipboardGetResponse> {
  const res = await axios.post<ClipboardGetResponse>('/api/control/clipboard/get', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function sendPaste(
  ...
  const res = await axios.post<ControlResponse>('/api/control/paste', {
    device_id: deviceId ?? null,
    delay,
  });
  return res.data;
...
export async function sendSelectAll(
  deviceId?: string | null,
  delay: number = 0
): Promise<ControlResponse> {
  const res = await axios.post<ControlResponse>('/api/control/select-all', {
    device_id: deviceId ?? null,
    delay,
  });
  return res.data;
...
export interface InstalledAppsResponse {
  success: boolean;
  system: InstalledAppInfo[];
  third_party: InstalledAppInfo[];
  error?: string;
}
...
export async function getInstalledApps(
  ...
  const res = await axios.post<InstalledAppsResponse>('/api/control/apps', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function forceStopApp(
  ...
  const res = await axios.post<{ success: boolean; error?: string }>('/api/control/force-stop', {
    device_id: deviceId ?? null,
    package: packageName,
  });
  return res.data;
...
export async function getRecentApps(
  ...
  const res = await axios.post<{ success: boolean; packages: string[]; error?: string }>(
    '/api/control/recent-apps',
    { device_id: deviceId ?? null }
  );
  return res.data;
}
...
export async function getAppState(
  packageName: string,
  deviceId?: string | null
): Promise<{ success: boolean; running: boolean; error?: string }> {
  const res = await axios.post<{ success: boolean; running: boolean; error?: string }>(
    '/api/control/app-state',
    { device_id: deviceId ?? null, package: packageName }
  );
  return res.data;
}
...
export async function runPytest(
  code: string,
  filename: string = 'test_device_control.py'
): Promise<PytestRunResponse> {
  const res = await axios.post<PytestRunResponse>('/api/control/pytest/run', {
    code,
    filename,
  });
  return res.data;
...
// YAML Runner
export interface YamlRunResponse {
  success: boolean;
  output: string;
  error?: string;
}
...
export async function runYaml(
  code: string,
  filename: string = 'test_device.yaml'
): Promise<YamlRunResponse> {
  const res = await axios.post<YamlRunResponse>('/api/control/yaml/run', {
    code,
    filename,
  });
  return res.data;
...
// GIF Generation
export interface GifGenerateResponse {
  success: boolean;
  gif: string;
  frame_count: number;
  error?: string;
...
): Promise<GifGenerateResponse> {
  const res = await axios.post<GifGenerateResponse>('/api/control/gif/generate', {
    images,
    duration_ms: durationMs,
  });
  return res.data;
...
export interface ConfigResponse {
  ...
  decision_api_key_masked?: string; // 脱敏后的决策模型 API Key
  decision_uses_fallback?: boolean; // 决策模型是否使用了回退
  // 视觉能力
  supports_vision?: boolean; // 模型是否支持图像输入
}
...
export async function testConfig(
  ...
  const res = await axios.post<ConfigTestResponse>('/api/config/test', req);
  return res.data;
}
...
export async function listTaskTemplates(
  ...
  const res = await axios.get<{ templates: TaskTemplate[] }>(
    '/task-templates',
    { params }
  );
...
export async function getTaskTemplate(
  ...
  const res = await axios.get<TaskTemplate>(`/task-templates/${id}`);
  return res.data;
}
...
export async function createTaskTemplate(data: {
  ...
  const res = await axios.post<TaskTemplate>('/task-templates', data);
  return res.data;
}

export async function updateTaskTemplate(
  id: string,
  data: { name?: string; description?: string; message?: string; category?: string }
): Promise<TaskTemplate> {
  const res = await axios.put<TaskTemplate>(`/task-templates/${id}`, data);
  return res.data;
}
...
export async function batchExecute(
  ...
  const res = await axios.post('/batch/execute', {
...
export async function getDeviceHealth(serial: string): Promise<DeviceHealth> {
  const res = await axios.get<DeviceHealth>(
    `/api/devices/${serial}/health`
  );
  return res.data;
}
...
export async function getNotificationConfig(): Promise<NotificationConfig> {
  const res = await axios.get<NotificationConfig>('/notifications/config');
  return res.data;
}
...
export async function updateNotificationConfig(
  ...
  const res = await axios.post<NotificationConfig>('/notifications/config', data);
  return res.data;
}
...
export async function testNotification(): Promise<{
  ...
  const res = await axios.post('/notifications/test');
  return res.data;
}
...
export async function startScreenRecord(
  ...
  const res = await axios.post<RecordStartResponse>('/api/control/record/start', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
...
export async function stopScreenRecord(
  deviceId?: string | null
): Promise<RecordStopResponse> {
  const res = await axios.post<RecordStopResponse>('/api/control/record/stop', {
    device_id: deviceId ?? null,
  });
  return res.data;
}
